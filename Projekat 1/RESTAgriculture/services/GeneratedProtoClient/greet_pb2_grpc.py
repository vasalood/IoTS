...
class GreeterStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetSensorData = channel.unary_unary(
                '/greet.Greeter/GetSensorData',
                request_serializer=greet__pb2.SensorRequest.SerializeToString,
                response_deserializer=greet__pb2.SensorReply.FromString,
                _registered_method=True)
...
def add_GreeterServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'GetSensorData': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=greet__pb2.SensorRequest.FromString,
                    response_serializer=greet__pb2.SensorReply.SerializeToString,
            ),
    }
...
class Greeter(object):
    ...
    def GetSensorData(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/greet.Greeter/GetSensorData',
            greet__pb2.SensorRequest.SerializeToString,
            greet__pb2.SensorReply.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
